 ...
 * Service version: 0.8.68
 * apibuilder 0.14.93 app.apibuilder.io/flow/organization/latest/play_2_8_client
 */
package io.flow.organization.v0.models {
  ...
  object CountryPickerSource {
     ...
     * country
     */
    case object Experience extends CountryPickerSource { override def toString = "experience" }
    /**
     ...
     */
    case object Destination extends CountryPickerSource { override def toString = "destination" }
  ...
  object EcommercePlatformType {
     ...
     * above.
     */
    val all: scala.List[EcommercePlatformType] = scala.List(Commercetools, Custom, Magento, Shopify, Sfcc, Solidus, Workarea)
...
package io.flow.organization.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsOrganizationCountryPickerSource = new play.api.libs.json.Reads[io.flow.organization.v0.models.CountryPickerSource] {
    ...
    implicit def jsonWritesOrganizationCountryPickerSource: play.api.libs.json.Writes[CountryPickerSource] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.CountryPickerSource] {
        def writes(obj: io.flow.organization.v0.models.CountryPickerSource) = {
          jsonWritesOrganizationCountryPickerSource(obj)
        }
      }
    }

    implicit val jsonReadsOrganizationEcommercePlatformType = new play.api.libs.json.Reads[io.flow.organization.v0.models.EcommercePlatformType] {
    ...
    implicit def jsonWritesOrganizationEcommercePlatformType: play.api.libs.json.Writes[EcommercePlatformType] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.EcommercePlatformType] {
        def writes(obj: io.flow.organization.v0.models.EcommercePlatformType) = {
    ...
    implicit def jsonWritesOrganizationCountryPicker: play.api.libs.json.Writes[CountryPicker] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.CountryPicker] {
        def writes(obj: io.flow.organization.v0.models.CountryPicker) = {
    ...
    implicit def jsonWritesOrganizationCountryPickerForm: play.api.libs.json.Writes[CountryPickerForm] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.CountryPickerForm] {
        def writes(obj: io.flow.organization.v0.models.CountryPickerForm) = {
    ...
    implicit def jsonWritesOrganizationEcommercePlatform: play.api.libs.json.Writes[EcommercePlatform] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.EcommercePlatform] {
        def writes(obj: io.flow.organization.v0.models.EcommercePlatform) = {
    ...
    implicit def jsonWritesOrganizationEcommercePlatformForm: play.api.libs.json.Writes[EcommercePlatformForm] = {
      new play.api.libs.json.Writes[io.flow.organization.v0.models.EcommercePlatformForm] {
        def writes(obj: io.flow.organization.v0.models.EcommercePlatformForm) = {
...
package io.flow.organization.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/organization/latest/play_2_8_client"
    val Version = "0.8.68"
    val VersionMajor = 0
