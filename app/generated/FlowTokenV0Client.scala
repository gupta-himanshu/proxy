...
package io.flow.token.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesTokenOrganizationToken: play.api.libs.json.Writes[OrganizationToken] = {
      new play.api.libs.json.Writes[io.flow.token.v0.models.OrganizationToken] {
        def writes(obj: io.flow.token.v0.models.OrganizationToken) = {
    ...
    implicit def jsonWritesTokenPartnerToken: play.api.libs.json.Writes[PartnerToken] = {
      new play.api.libs.json.Writes[io.flow.token.v0.models.PartnerToken] {
        def writes(obj: io.flow.token.v0.models.PartnerToken) = {
