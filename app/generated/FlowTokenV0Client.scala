  ...
  package object json {
    ...
    def jsObjectChannelToken(obj: io.flow.token.v0.models.ChannelToken): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "channel" -> io.flow.channel.v0.models.json.jsObjectChannelReference(obj.channel),
    ...
    implicit def jsonReadsTokenChannelTokenForm: play.api.libs.json.Reads[ChannelTokenForm] = {
      for {
  ...
  class Client(
    ...
    object ChannelTokens extends ChannelTokens {
      override def post(
        ...
        _executeRequest("POST", s"/tokens/channel", body = Some(payload), requestHeaders = requestHeaders).map {
