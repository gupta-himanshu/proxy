 ...
 * Service version: 0.8.48
 * apibuilder 0.14.93 app.apibuilder.io/flow/fulfillment/latest/play_2_x_json
 */
package io.flow.fulfillment.v0.models {
  ...
  final case class DigitalDelivery(
    ...
    prices: _root_.scala.Option[Seq[io.flow.order.price.v0.models.OrderPriceDetail]] = None,
    total: _root_.scala.Option[io.flow.catalog.v0.models.LocalizedTotal] = None
  ) extends Delivery
  ...
  final case class Tier(
    id: String,
    direction: io.flow.fulfillment.v0.models.LaneDirection = io.flow.fulfillment.v0.models.LaneDirection.Outbound,
...
package io.flow.fulfillment.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsFulfillmentDeliveryItem: play.api.libs.json.Reads[DeliveryItem] = {
      ...
      } yield DeliveryItem(number, quantity, shipmentEstimate, price, attributes, center, lineNumber)
    }
    ...
    implicit def jsonReadsFulfillmentPhysicalDelivery: play.api.libs.json.Reads[PhysicalDelivery] = {
      ...
      } yield PhysicalDelivery(id, key, center, items, options, specialServices, prices, total, goodsSupply)
    }
    ...
    implicit def jsonReadsFulfillmentTier: play.api.libs.json.Reads[Tier] = {
      ...
      } yield Tier(id, direction, integration, name, message, rules, services, strategy, visibility, currency, description, display, shippingLane, surchargeSettings, lane)
    }
