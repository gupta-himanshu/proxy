...
package io.flow.catalog.v0.models {
  ...
  sealed trait ExpandableSubcatalog extends _root_.scala.Product with _root_.scala.Serializable {
    def expandableSubcatalogDiscriminator: ExpandableSubcatalogDiscriminator
  ...
  sealed trait LocalizedPrice extends _root_.scala.Product with _root_.scala.Serializable {
    def localizedPriceKey: LocalizedPriceKey
    def currency: String
    def amount: Double
    def label: String
  ...
  final case class LocalizedItemDuty(
    ...
    override val localizedPriceKey: LocalizedPriceKey = LocalizedPriceKey.LocalizedItemDuty
  }
  ...
  final case class LocalizedItemPrice(
    ...
    override val localizedPriceKey: LocalizedPriceKey = LocalizedPriceKey.LocalizedItemPrice
  }
  ...
  final case class LocalizedItemVat(
    ...
    override val localizedPriceKey: LocalizedPriceKey = LocalizedPriceKey.LocalizedItemVat
  }
  ...
  final case class LocalizedTotal(
    ...
    override val localizedPriceKey: LocalizedPriceKey = LocalizedPriceKey.LocalizedTotal
  }
  ...
  final case class Subcatalog(
    ...
    override val expandableSubcatalogDiscriminator: ExpandableSubcatalogDiscriminator = ExpandableSubcatalogDiscriminator.Subcatalog
  }
  ...
  final case class SubcatalogReference(
    ...
    override val expandableSubcatalogDiscriminator: ExpandableSubcatalogDiscriminator = ExpandableSubcatalogDiscriminator.SubcatalogReference
  }
  ...
  final case class ExpandableSubcatalogUndefinedType(
    ...
    override val expandableSubcatalogDiscriminator: ExpandableSubcatalogDiscriminator = ExpandableSubcatalogDiscriminator.UNDEFINED(description)
  }
  ...
  final case class LocalizedPriceUndefinedType(
    ...
    override val localizedPriceKey: LocalizedPriceKey = LocalizedPriceKey.UNDEFINED(description)
  ...
  object AdjustmentReasonKey {
     ...
     */
    case object DutyDeminimis extends AdjustmentReasonKey {
      override def toString = "duty_deminimis"
    }
    /**
     * If the VAT de minimis value has not been met, an adjustment may be made to
     * offset any previously calculated VAT.
     */
    case object VatDeminimis extends AdjustmentReasonKey {
      override def toString = "vat_deminimis"
    }
    /**
  ...
  object AttributeIntent {
     ...
     */
    case object Brand extends AttributeIntent {
      override def toString = "brand"
    }
    /**
     ...
     */
    case object CountriesOfOrigin extends AttributeIntent {
      override def toString = "countries_of_origin"
    }
    /**
     ...
     */
    case object ProductId extends AttributeIntent {
      override def toString = "product_id"
    }
    /**
     * Identifies whether the item is a physical or digital good
     */
    case object FulfillmentMethod extends AttributeIntent {
      override def toString = "fulfillment_method"
    }
    /**
     * Identifies whether this item may contain hazardous materials
     */
    case object Hazardous extends AttributeIntent {
      override def toString = "hazardous"
    }
    /**
     * A price for the item in the organization's base currency (will be localized
     * based on each Experience's pricing policy)
     */
    case object Price extends AttributeIntent {
     ...
     */
    case object Taxability extends AttributeIntent {
      override def toString = "taxability"
    }
    /**
     * A URL of the product detail page of the item
     */
    case object ConsumerUrl extends AttributeIntent {
      override def toString = "consumer_url"
    }
    /**
     * The Global Trade Item Number of this item.
     */
    case object Gtin extends AttributeIntent {
      override def toString = "gtin"
    }
    /**
     * The Manufacturer Part Number of this item.
     */
    case object Mpn extends AttributeIntent {
      override def toString = "mpn"
    }
    /**
     * Identifies a facet.
     */
     ...
     */
    case object Eccn extends AttributeIntent {
      override def toString = "eccn"
    }
    /**
     * Identifies whether the item can be returned. If not present on an item, it is
     * assumed to be returnable.
     */
    case object Returnable extends AttributeIntent {
      override def toString = "returnable"
    }
    /**
     * Identifies whether the attribute can be used to search for an item.
     */
    case object Searchable extends AttributeIntent {
      override def toString = "searchable"
    }
    /**
     ...
     */
    case object MinDaysToShip extends AttributeIntent {
      override def toString = "min_days_to_ship"
    }
    /**
     * Indicates a lead time to prepare an item for shipment. If specified, we will
     * include this lead time in the delivery window calculation
     */
    case object MaxDaysToShip extends AttributeIntent {
      override def toString = "max_days_to_ship"
    }
    /**
     * Identifies the attribute is used as an item number in the commercial invoice.
     */
    case object CommercialInvoiceItemNumber extends AttributeIntent {
      override def toString = "commercial_invoice_item_number"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object FulfillmentMethodType {
     ...
     */
    case object FulfillmentMethod extends FulfillmentMethodType {
      override def toString = "fulfillment_method"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
  ...
  object FulfillmentMethodValue {
     ...
     * Gift Card).
     */
    case object Digital extends FulfillmentMethodValue {
      override def toString = "digital"
    }
    /**
     * Indicates item will be shipped in a physical package.
     */
    case object Physical extends FulfillmentMethodValue {
      override def toString = "physical"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object ImageTag {
     ...
     * Console.
     */
    case object Thumbnail extends ImageTag {
      override def toString = "thumbnail"
    }
    /**
     ...
     */
    case object Checkout extends ImageTag {
      override def toString = "checkout"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object ReturnItemStatus {
     ...
     */
    case object Returnable extends ReturnItemStatus {
      override def toString = "returnable"
    }
    /**
     * The item in the catalog cannot be returned
     */
    case object NonReturnable extends ReturnItemStatus {
      override def toString = "non-returnable"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object SubcatalogItemStatus {
     ...
     */
    case object Excluded extends SubcatalogItemStatus {
      override def toString = "excluded"
    }
    /**
     * The item is included in the associated subcatalog.
     */
    case object Included extends SubcatalogItemStatus {
      override def toString = "included"
    }
    /**
     * Item is not allowed to be sold in the market associated with the given
     * subcatalog.
     */
    case object Restricted extends SubcatalogItemStatus {
      override def toString = "restricted"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object TaxabilityType {
     ...
     */
    case object TaxRule extends TaxabilityType {
      override def toString = "tax_rule"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object TaxabilityValue {
     ...
     */
    case object Exempt extends TaxabilityValue {
      override def toString = "exempt"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
...
package io.flow.catalog.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsCatalogAdjustmentReasonKey: play.api.libs.json.Reads[io.flow.catalog.v0.models.AdjustmentReasonKey] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.AdjustmentReasonKey] {
    ...
    implicit def jsonWritesCatalogAdjustmentReasonKey: play.api.libs.json.Writes[AdjustmentReasonKey] = {
      (obj: io.flow.catalog.v0.models.AdjustmentReasonKey) => {
        jsonWritesCatalogAdjustmentReasonKey(obj)
      }
    }

    implicit val jsonReadsCatalogAttributeIntent: play.api.libs.json.Reads[io.flow.catalog.v0.models.AttributeIntent] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.AttributeIntent] {
    ...
    implicit def jsonWritesCatalogAttributeIntent: play.api.libs.json.Writes[AttributeIntent] = {
      (obj: io.flow.catalog.v0.models.AttributeIntent) => {
        jsonWritesCatalogAttributeIntent(obj)
      }
    }

    implicit val jsonReadsCatalogFulfillmentMethodType: play.api.libs.json.Reads[io.flow.catalog.v0.models.FulfillmentMethodType] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.FulfillmentMethodType] {
    ...
    implicit def jsonWritesCatalogFulfillmentMethodType: play.api.libs.json.Writes[FulfillmentMethodType] = {
      (obj: io.flow.catalog.v0.models.FulfillmentMethodType) => {
        jsonWritesCatalogFulfillmentMethodType(obj)
      }
    }

    implicit val jsonReadsCatalogFulfillmentMethodValue: play.api.libs.json.Reads[io.flow.catalog.v0.models.FulfillmentMethodValue] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.FulfillmentMethodValue] {
    ...
    implicit def jsonWritesCatalogFulfillmentMethodValue: play.api.libs.json.Writes[FulfillmentMethodValue] = {
      (obj: io.flow.catalog.v0.models.FulfillmentMethodValue) => {
        jsonWritesCatalogFulfillmentMethodValue(obj)
      }
    }

    implicit val jsonReadsCatalogImageTag: play.api.libs.json.Reads[io.flow.catalog.v0.models.ImageTag] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.ImageTag] {
    ...
    implicit def jsonWritesCatalogImageTag: play.api.libs.json.Writes[ImageTag] = {
      (obj: io.flow.catalog.v0.models.ImageTag) => {
        jsonWritesCatalogImageTag(obj)
      }
    }

    implicit val jsonReadsCatalogReturnItemStatus: play.api.libs.json.Reads[io.flow.catalog.v0.models.ReturnItemStatus] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.ReturnItemStatus] {
    ...
    implicit def jsonWritesCatalogReturnItemStatus: play.api.libs.json.Writes[ReturnItemStatus] = {
      (obj: io.flow.catalog.v0.models.ReturnItemStatus) => {
        jsonWritesCatalogReturnItemStatus(obj)
      }
    }

    implicit val jsonReadsCatalogSubcatalogItemStatus: play.api.libs.json.Reads[io.flow.catalog.v0.models.SubcatalogItemStatus] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.SubcatalogItemStatus] {
    ...
    implicit def jsonWritesCatalogSubcatalogItemStatus: play.api.libs.json.Writes[SubcatalogItemStatus] = {
      (obj: io.flow.catalog.v0.models.SubcatalogItemStatus) => {
        jsonWritesCatalogSubcatalogItemStatus(obj)
      }
    }

    implicit val jsonReadsCatalogTaxabilityType: play.api.libs.json.Reads[io.flow.catalog.v0.models.TaxabilityType] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.TaxabilityType] {
    ...
    implicit def jsonWritesCatalogTaxabilityType: play.api.libs.json.Writes[TaxabilityType] = {
      (obj: io.flow.catalog.v0.models.TaxabilityType) => {
        jsonWritesCatalogTaxabilityType(obj)
      }
    }

    implicit val jsonReadsCatalogTaxabilityValue: play.api.libs.json.Reads[io.flow.catalog.v0.models.TaxabilityValue] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.TaxabilityValue] {
    ...
    implicit def jsonWritesCatalogTaxabilityValue: play.api.libs.json.Writes[TaxabilityValue] = {
      (obj: io.flow.catalog.v0.models.TaxabilityValue) => {
        jsonWritesCatalogTaxabilityValue(obj)
      }
    }

    implicit val jsonReadsCatalogUpdatePolicy: play.api.libs.json.Reads[io.flow.catalog.v0.models.UpdatePolicy] = new play.api.libs.json.Reads[io.flow.catalog.v0.models.UpdatePolicy] {
    ...
    implicit def jsonWritesCatalogUpdatePolicy: play.api.libs.json.Writes[UpdatePolicy] = {
      (obj: io.flow.catalog.v0.models.UpdatePolicy) => {
    ...
    implicit def jsonWritesCatalogAdjustmentReason: play.api.libs.json.Writes[AdjustmentReason] = {
      (obj: io.flow.catalog.v0.models.AdjustmentReason) => {
    ...
    implicit def jsonWritesCatalogAttribute: play.api.libs.json.Writes[Attribute] = {
      (obj: io.flow.catalog.v0.models.Attribute) => {
    ...
    implicit def jsonWritesCatalogAttributeForm: play.api.libs.json.Writes[AttributeForm] = {
      (obj: io.flow.catalog.v0.models.AttributeForm) => {
    ...
    implicit def jsonWritesCatalogAttributeVersion: play.api.libs.json.Writes[AttributeVersion] = {
      (obj: io.flow.catalog.v0.models.AttributeVersion) => {
    ...
    implicit def jsonWritesCatalogCatalog: play.api.libs.json.Writes[Catalog] = {
      (obj: io.flow.catalog.v0.models.Catalog) => {
        jsObjectCatalog(obj)
      }
    }
    ...
    implicit def jsonWritesCatalogCatalogReference: play.api.libs.json.Writes[CatalogReference] = {
      (obj: io.flow.catalog.v0.models.CatalogReference) => {
    ...
    implicit def jsonWritesCatalogCatalogStatistics: play.api.libs.json.Writes[CatalogStatistics] = {
      (obj: io.flow.catalog.v0.models.CatalogStatistics) => {
    ...
    implicit def jsonWritesCatalogCatalogVersion: play.api.libs.json.Writes[CatalogVersion] = {
      (obj: io.flow.catalog.v0.models.CatalogVersion) => {
    ...
    implicit def jsonWritesCatalogFlowItemIndexMetadata: play.api.libs.json.Writes[FlowItemIndexMetadata] = {
      (obj: io.flow.catalog.v0.models.FlowItemIndexMetadata) => {
    ...
    implicit def jsonWritesCatalogImage: play.api.libs.json.Writes[Image] = {
      (obj: io.flow.catalog.v0.models.Image) => {
        jsObjectImage(obj)
      }
    }
    ...
    implicit def jsonWritesCatalogImageForm: play.api.libs.json.Writes[ImageForm] = {
      (obj: io.flow.catalog.v0.models.ImageForm) => {
    ...
    implicit def jsonWritesCatalogItem: play.api.libs.json.Writes[Item] = {
      (obj: io.flow.catalog.v0.models.Item) => {
        jsObjectItem(obj)
      }
    }
    ...
    implicit def jsonWritesCatalogItemAttributesPatchForm: play.api.libs.json.Writes[ItemAttributesPatchForm] = {
      (obj: io.flow.catalog.v0.models.ItemAttributesPatchForm) => {
    ...
    implicit def jsonWritesCatalogItemForm: play.api.libs.json.Writes[ItemForm] = {
      (obj: io.flow.catalog.v0.models.ItemForm) => {
    ...
    implicit def jsonWritesCatalogItemFormOverlay: play.api.libs.json.Writes[ItemFormOverlay] = {
      (obj: io.flow.catalog.v0.models.ItemFormOverlay) => {
    ...
    implicit def jsonWritesCatalogItemFormOverlayForm: play.api.libs.json.Writes[ItemFormOverlayForm] = {
      (obj: io.flow.catalog.v0.models.ItemFormOverlayForm) => {
    ...
    implicit def jsonWritesCatalogItemPriceUpdateForm: play.api.libs.json.Writes[ItemPriceUpdateForm] = {
      (obj: io.flow.catalog.v0.models.ItemPriceUpdateForm) => {
    ...
    implicit def jsonWritesCatalogItemPriceUpdatePutForm: play.api.libs.json.Writes[ItemPriceUpdatePutForm] = {
      (obj: io.flow.catalog.v0.models.ItemPriceUpdatePutForm) => {
    ...
    implicit def jsonWritesCatalogItemStatistics: play.api.libs.json.Writes[ItemStatistics] = {
      (obj: io.flow.catalog.v0.models.ItemStatistics) => {
    ...
    implicit def jsonWritesCatalogItemVersion: play.api.libs.json.Writes[ItemVersion] = {
      (obj: io.flow.catalog.v0.models.ItemVersion) => {
    ...
    implicit def jsonWritesCatalogLocal: play.api.libs.json.Writes[Local] = {
      (obj: io.flow.catalog.v0.models.Local) => {
        jsObjectLocal(obj)
      }
    }
    ...
    implicit def jsonWritesCatalogLocalizedAdjustment: play.api.libs.json.Writes[LocalizedAdjustment] = {
      (obj: io.flow.catalog.v0.models.LocalizedAdjustment) => {
    ...
    implicit def jsonWritesCatalogLocalizedItemDuty: play.api.libs.json.Writes[LocalizedItemDuty] = {
      (obj: io.flow.catalog.v0.models.LocalizedItemDuty) => {
    ...
    implicit def jsonWritesCatalogLocalizedItemPrice: play.api.libs.json.Writes[LocalizedItemPrice] = {
      (obj: io.flow.catalog.v0.models.LocalizedItemPrice) => {
    ...
    implicit def jsonWritesCatalogLocalizedItemVat: play.api.libs.json.Writes[LocalizedItemVat] = {
      (obj: io.flow.catalog.v0.models.LocalizedItemVat) => {
    ...
    implicit def jsonWritesCatalogLocalizedTotal: play.api.libs.json.Writes[LocalizedTotal] = {
      (obj: io.flow.catalog.v0.models.LocalizedTotal) => {
    ...
    implicit def jsonWritesCatalogOptions: play.api.libs.json.Writes[Options] = {
      (obj: io.flow.catalog.v0.models.Options) => {
        jsObjectOptions(obj)
      }
    }
    ...
    implicit def jsonWritesCatalogSubcatalog: play.api.libs.json.Writes[Subcatalog] = {
      (obj: io.flow.catalog.v0.models.Subcatalog) => {
    ...
    implicit def jsonWritesCatalogSubcatalogForm: play.api.libs.json.Writes[SubcatalogForm] = {
      (obj: io.flow.catalog.v0.models.SubcatalogForm) => {
    ...
    implicit def jsonWritesCatalogSubcatalogItem: play.api.libs.json.Writes[SubcatalogItem] = {
      (obj: io.flow.catalog.v0.models.SubcatalogItem) => {
    ...
    implicit def jsonWritesCatalogSubcatalogItemVersion: play.api.libs.json.Writes[SubcatalogItemVersion] = {
      (obj: io.flow.catalog.v0.models.SubcatalogItemVersion) => {
    ...
    implicit def jsonWritesCatalogSubcatalogReference: play.api.libs.json.Writes[SubcatalogReference] = {
      (obj: io.flow.catalog.v0.models.SubcatalogReference) => {
    ...
    implicit def jsonWritesCatalogSubcatalogSettings: play.api.libs.json.Writes[SubcatalogSettings] = {
      (obj: io.flow.catalog.v0.models.SubcatalogSettings) => {
    ...
    implicit def jsonWritesCatalogSubcatalogSettingsForm: play.api.libs.json.Writes[SubcatalogSettingsForm] = {
      (obj: io.flow.catalog.v0.models.SubcatalogSettingsForm) => {
    ...
    implicit def jsonWritesCatalogSubcatalogStatistics: play.api.libs.json.Writes[SubcatalogStatistics] = {
      (obj: io.flow.catalog.v0.models.SubcatalogStatistics) => {
    ...
    implicit def jsonWritesCatalogSubcatalogVersion: play.api.libs.json.Writes[SubcatalogVersion] = {
      (obj: io.flow.catalog.v0.models.SubcatalogVersion) => {
        jsObjectSubcatalogVersion(obj)
      }
    }

    implicit def jsonReadsCatalogExpandableSubcatalog: play.api.libs.json.Reads[ExpandableSubcatalog] = (js: play.api.libs.json.JsValue) => {
    ...
    implicit def jsonWritesCatalogExpandableSubcatalog: play.api.libs.json.Writes[ExpandableSubcatalog] = {
      (obj: io.flow.catalog.v0.models.ExpandableSubcatalog) => {
        jsObjectExpandableSubcatalog(obj)
      }
    }

    implicit def jsonReadsCatalogLocalizedPrice: play.api.libs.json.Reads[LocalizedPrice] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonWritesCatalogLocalizedPrice: play.api.libs.json.Writes[LocalizedPrice] = {
      (obj: io.flow.catalog.v0.models.LocalizedPrice) => {
