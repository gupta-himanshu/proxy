 ...
 * Service version: 0.9.98
 * apibuilder 0.15.11 app.apibuilder.io/flow/catalog/latest/play_2_x_json
 */
package io.flow.catalog.v0.models {
  ...
  object AttributeIntent {
     ...
     * above.
     */
    val all: scala.List[AttributeIntent] = scala.List(Brand, Color, CountriesOfOrigin, ProductId, FulfillmentMethod, Hazardous, Price, Size, Sku, Taxability, ConsumerUrl, Gtin, Mpn, Facet, Eccn, Returnable, Searchable)
