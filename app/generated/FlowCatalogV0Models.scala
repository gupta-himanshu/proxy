 ...
 * Service version: 0.8.79
 * apibuilder 0.14.93 app.apibuilder.io/flow/catalog/latest/play_2_x_json
 */
package io.flow.catalog.v0.models {
  ...
  object AttributeIntent {
     ...
     * above.
     */
    val all: scala.List[AttributeIntent] = scala.List(Brand, Color, CountriesOfOrigin, ProductId, FulfillmentMethod, Hazardous, Price, Size, Sku, Taxability, ConsumerUrl, Gtin, Mpn, ExcludedRegions, Facet)
        ...
        js match {
          ...
          case _ => {
            (js \ "value").validate[String] match {
              ...
              case err: play.api.libs.json.JsError =>
                (js \ "query_type").validate[String] match {
                  case play.api.libs.json.JsSuccess(v, _) => play.api.libs.json.JsSuccess(io.flow.catalog.v0.models.QueryType(v))
                  case err: play.api.libs.json.JsError => err
                }
            }
