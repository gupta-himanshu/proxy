...
package io.flow.query.builder.v0.models {
  ...
  sealed trait AvailableFilter extends _root_.scala.Product with _root_.scala.Serializable {
    def availableFilterDiscriminator: AvailableFilterDiscriminator
  ...
  sealed trait QueryBuilderForm extends _root_.scala.Product with _root_.scala.Serializable {
    def queryBuilderFormDiscriminator: QueryBuilderFormDiscriminator
  ...
  sealed trait QueryFilter extends _root_.scala.Product with _root_.scala.Serializable {
    def queryFilterDiscriminator: QueryFilterDiscriminator
  ...
  object QueryFilterDiscriminator {
    ...
    val default: QueryFilterDiscriminator = QueryFilterStructured

  }

  sealed trait QueryFilterForm extends _root_.scala.Product with _root_.scala.Serializable {
    def queryFilterFormDiscriminator: QueryFilterFormDiscriminator
  ...
  object QueryFilterFormDiscriminator {
    ...
    val default: QueryFilterFormDiscriminator = QueryFilterStructuredForm
  ...
  final case class AvailableFilterStructured(
    ...
    override val availableFilterDiscriminator: AvailableFilterDiscriminator = AvailableFilterDiscriminator.AvailableFilterStructured
  }
  ...
  final case class AvailableFilterUnstructured(
    ...
    override val availableFilterDiscriminator: AvailableFilterDiscriminator = AvailableFilterDiscriminator.AvailableFilterUnstructured
  }
  ...
  final case class QueryBuilderFilterForm(
    ...
    override val queryBuilderFormDiscriminator: QueryBuilderFormDiscriminator = QueryBuilderFormDiscriminator.QueryBuilderFilterForm
  }

  final case class QueryBuilderQueryForm(
    q: String
  ) extends QueryBuilderForm {
    override val queryBuilderFormDiscriminator: QueryBuilderFormDiscriminator = QueryBuilderFormDiscriminator.QueryBuilderQueryForm
  }
  ...
  final case class QueryFilterStructured(
    ...
    override val queryFilterDiscriminator: QueryFilterDiscriminator = QueryFilterDiscriminator.QueryFilterStructured
  }
  ...
  final case class QueryFilterStructuredForm(
    ...
    override val queryFilterFormDiscriminator: QueryFilterFormDiscriminator = QueryFilterFormDiscriminator.QueryFilterStructuredForm
  }
  ...
  final case class QueryFilterUnstructured(
    ...
    override val queryFilterDiscriminator: QueryFilterDiscriminator = QueryFilterDiscriminator.QueryFilterUnstructured
  }

  final case class QueryFilterUnstructuredForm(
    q: String
  ) extends QueryFilterForm {
    override val queryFilterFormDiscriminator: QueryFilterFormDiscriminator = QueryFilterFormDiscriminator.QueryFilterUnstructuredForm
  }
  ...
  final case class AvailableFilterUndefinedType(
    ...
    override val availableFilterDiscriminator: AvailableFilterDiscriminator = AvailableFilterDiscriminator.UNDEFINED(description)
  }
  ...
  final case class QueryBuilderFormUndefinedType(
    ...
    override val queryBuilderFormDiscriminator: QueryBuilderFormDiscriminator = QueryBuilderFormDiscriminator.UNDEFINED(description)
  }
  ...
  final case class QueryFilterUndefinedType(
    ...
    override val queryFilterDiscriminator: QueryFilterDiscriminator = QueryFilterDiscriminator.UNDEFINED(description)
  }
  ...
  final case class QueryFilterFormUndefinedType(
    ...
    override val queryFilterFormDiscriminator: QueryFilterFormDiscriminator = QueryFilterFormDiscriminator.UNDEFINED(description)
  }
  /**
  ...
  object AvailableFilterFormat {
     ...
     */
    case object Date extends AvailableFilterFormat {
...
package io.flow.query.builder.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsQueryBuilderAvailableFilterFormat: play.api.libs.json.Reads[io.flow.query.builder.v0.models.AvailableFilterFormat] = new play.api.libs.json.Reads[io.flow.query.builder.v0.models.AvailableFilterFormat] {
    ...
    implicit def jsonWritesQueryBuilderAvailableFilterFormat: play.api.libs.json.Writes[AvailableFilterFormat] = {
      (obj: io.flow.query.builder.v0.models.AvailableFilterFormat) => {
    ...
    implicit def jsonWritesQueryBuilderAvailableFilterStructured: play.api.libs.json.Writes[AvailableFilterStructured] = {
      (obj: io.flow.query.builder.v0.models.AvailableFilterStructured) => {
    ...
    implicit def jsonWritesQueryBuilderAvailableFilterUnstructured: play.api.libs.json.Writes[AvailableFilterUnstructured] = {
      (obj: io.flow.query.builder.v0.models.AvailableFilterUnstructured) => {
    ...
    implicit def jsonWritesQueryBuilderQuery: play.api.libs.json.Writes[Query] = {
      (obj: io.flow.query.builder.v0.models.Query) => {
        jsObjectQuery(obj)
      }
    }
    ...
    implicit def jsonWritesQueryBuilderQueryBuilder: play.api.libs.json.Writes[QueryBuilder] = {
      (obj: io.flow.query.builder.v0.models.QueryBuilder) => {
    ...
    implicit def jsonWritesQueryBuilderQueryBuilderFilterForm: play.api.libs.json.Writes[QueryBuilderFilterForm] = {
      (obj: io.flow.query.builder.v0.models.QueryBuilderFilterForm) => {
    ...
    implicit def jsonWritesQueryBuilderQueryBuilderQueryForm: play.api.libs.json.Writes[QueryBuilderQueryForm] = {
      (obj: io.flow.query.builder.v0.models.QueryBuilderQueryForm) => {
    ...
    implicit def jsonWritesQueryBuilderQueryFilterStructured: play.api.libs.json.Writes[QueryFilterStructured] = {
      (obj: io.flow.query.builder.v0.models.QueryFilterStructured) => {
    ...
    implicit def jsonWritesQueryBuilderQueryFilterStructuredForm: play.api.libs.json.Writes[QueryFilterStructuredForm] = {
      (obj: io.flow.query.builder.v0.models.QueryFilterStructuredForm) => {
    ...
    implicit def jsonWritesQueryBuilderQueryFilterUnstructured: play.api.libs.json.Writes[QueryFilterUnstructured] = {
      (obj: io.flow.query.builder.v0.models.QueryFilterUnstructured) => {
    ...
    implicit def jsonWritesQueryBuilderQueryFilterUnstructuredForm: play.api.libs.json.Writes[QueryFilterUnstructuredForm] = {
      (obj: io.flow.query.builder.v0.models.QueryFilterUnstructuredForm) => {
        jsObjectQueryFilterUnstructuredForm(obj)
      }
    }

    implicit def jsonReadsQueryBuilderAvailableFilter: play.api.libs.json.Reads[AvailableFilter] = (js: play.api.libs.json.JsValue) => {
    ...
    implicit def jsonWritesQueryBuilderAvailableFilter: play.api.libs.json.Writes[AvailableFilter] = {
      (obj: io.flow.query.builder.v0.models.AvailableFilter) => {
        jsObjectAvailableFilter(obj)
      }
    }

    implicit def jsonReadsQueryBuilderQueryBuilderForm: play.api.libs.json.Reads[QueryBuilderForm] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonWritesQueryBuilderQueryBuilderForm: play.api.libs.json.Writes[QueryBuilderForm] = {
      (obj: io.flow.query.builder.v0.models.QueryBuilderForm) => {
        jsObjectQueryBuilderForm(obj)
      }
    }

    implicit def jsonReadsQueryBuilderQueryFilter: play.api.libs.json.Reads[QueryFilter] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
      ...
      (js \ "discriminator").validate[String] match {
        case _: play.api.libs.json.JsError => readDiscriminator("structured")
        case s: play.api.libs.json.JsSuccess[String] => readDiscriminator(s.value)
      }
    }
    ...
    implicit def jsonWritesQueryBuilderQueryFilter: play.api.libs.json.Writes[QueryFilter] = {
      (obj: io.flow.query.builder.v0.models.QueryFilter) => {
        jsObjectQueryFilter(obj)
      }
    }

    implicit def jsonReadsQueryBuilderQueryFilterForm: play.api.libs.json.Reads[QueryFilterForm] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonWritesQueryBuilderQueryFilterForm: play.api.libs.json.Writes[QueryFilterForm] = {
      (obj: io.flow.query.builder.v0.models.QueryFilterForm) => {
