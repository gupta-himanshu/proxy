...
package io.flow.merchant.of.record.v0.models {
  ...
  object EconomicTitleLocation {
     ...
     */
    case object HighSeas extends EconomicTitleLocation {
      override def toString = "high_seas"
    }
    /**
     * Indicates title transferred at the originating fulfillment center
     */
    case object Origination extends EconomicTitleLocation {
      override def toString = "origination"
    }
    /**
     * Indicates title transferred at the destination
     */
    case object Destination extends EconomicTitleLocation {
  ...
  object FlowEntity {
     ...
     */
    case object FlowUsa extends FlowEntity {
      override def toString = "flow-usa"
    }
    /**
     ...
     */
    case object FlowCan extends FlowEntity {
      override def toString = "flow-can"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
...
package io.flow.merchant.of.record.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsMerchantOfRecordEconomicTitleLocation: play.api.libs.json.Reads[io.flow.merchant.of.record.v0.models.EconomicTitleLocation] = new play.api.libs.json.Reads[io.flow.merchant.of.record.v0.models.EconomicTitleLocation] {
    ...
    implicit def jsonWritesMerchantOfRecordEconomicTitleLocation: play.api.libs.json.Writes[EconomicTitleLocation] = {
      (obj: io.flow.merchant.of.record.v0.models.EconomicTitleLocation) => {
        jsonWritesMerchantOfRecordEconomicTitleLocation(obj)
      }
    }

    implicit val jsonReadsMerchantOfRecordFlowEntity: play.api.libs.json.Reads[io.flow.merchant.of.record.v0.models.FlowEntity] = new play.api.libs.json.Reads[io.flow.merchant.of.record.v0.models.FlowEntity] {
    ...
    implicit def jsonWritesMerchantOfRecordFlowEntity: play.api.libs.json.Writes[FlowEntity] = {
      (obj: io.flow.merchant.of.record.v0.models.FlowEntity) => {
