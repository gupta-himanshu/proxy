...
package io.flow.checkout.configuration.v0.models {
  ...
  object GoogleAnalyticsPlugin {
     ...
     */
    case object Ec extends GoogleAnalyticsPlugin { override def toString = "ec" }
...
package io.flow.checkout.configuration.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsCheckoutConfigurationCheckoutAssetType = new play.api.libs.json.Reads[io.flow.checkout.configuration.v0.models.CheckoutAssetType] {
    ...
    implicit def jsonWritesCheckoutConfigurationCheckoutAssetType: play.api.libs.json.Writes[CheckoutAssetType] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.CheckoutAssetType] {
        def writes(obj: io.flow.checkout.configuration.v0.models.CheckoutAssetType) = {
    ...
    implicit val jsonReadsCheckoutConfigurationCheckoutUrlType = new play.api.libs.json.Reads[io.flow.checkout.configuration.v0.models.CheckoutUrlType] {
    ...
    implicit def jsonWritesCheckoutConfigurationCheckoutUrlType: play.api.libs.json.Writes[CheckoutUrlType] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.CheckoutUrlType] {
        def writes(obj: io.flow.checkout.configuration.v0.models.CheckoutUrlType) = {
          jsonWritesCheckoutConfigurationCheckoutUrlType(obj)
        }
      }
    }

    implicit val jsonReadsCheckoutConfigurationGoogleAnalyticsPlugin = new play.api.libs.json.Reads[io.flow.checkout.configuration.v0.models.GoogleAnalyticsPlugin] {
    ...
    implicit def jsonWritesCheckoutConfigurationGoogleAnalyticsPlugin: play.api.libs.json.Writes[GoogleAnalyticsPlugin] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.GoogleAnalyticsPlugin] {
        def writes(obj: io.flow.checkout.configuration.v0.models.GoogleAnalyticsPlugin) = {
    ...
    implicit def jsonWritesCheckoutConfigurationCheckoutAnalytics: play.api.libs.json.Writes[CheckoutAnalytics] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.CheckoutAnalytics] {
        def writes(obj: io.flow.checkout.configuration.v0.models.CheckoutAnalytics) = {
    ...
    implicit def jsonWritesCheckoutConfigurationCheckoutAsset: play.api.libs.json.Writes[CheckoutAsset] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.CheckoutAsset] {
        def writes(obj: io.flow.checkout.configuration.v0.models.CheckoutAsset) = {
    ...
    implicit def jsonWritesCheckoutConfigurationCheckoutConfigurationForm: play.api.libs.json.Writes[CheckoutConfigurationForm] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.CheckoutConfigurationForm] {
        def writes(obj: io.flow.checkout.configuration.v0.models.CheckoutConfigurationForm) = {
    ...
    implicit def jsonWritesCheckoutConfigurationCheckoutUrl: play.api.libs.json.Writes[CheckoutUrl] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.CheckoutUrl] {
        def writes(obj: io.flow.checkout.configuration.v0.models.CheckoutUrl) = {
    ...
    implicit def jsonWritesCheckoutConfigurationFacebookPixel: play.api.libs.json.Writes[FacebookPixel] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.FacebookPixel] {
        def writes(obj: io.flow.checkout.configuration.v0.models.FacebookPixel) = {
    ...
    implicit def jsonWritesCheckoutConfigurationGoogleAnalytics: play.api.libs.json.Writes[GoogleAnalytics] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.GoogleAnalytics] {
        def writes(obj: io.flow.checkout.configuration.v0.models.GoogleAnalytics) = {
    ...
    implicit def jsonWritesCheckoutConfigurationGoogleGlobalSiteTag: play.api.libs.json.Writes[GoogleGlobalSiteTag] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.GoogleGlobalSiteTag] {
        def writes(obj: io.flow.checkout.configuration.v0.models.GoogleGlobalSiteTag) = {
    ...
    implicit def jsonWritesCheckoutConfigurationGoogleLinker: play.api.libs.json.Writes[GoogleLinker] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.GoogleLinker] {
        def writes(obj: io.flow.checkout.configuration.v0.models.GoogleLinker) = {
    ...
    implicit def jsonWritesCheckoutConfigurationGoogleTagManager: play.api.libs.json.Writes[GoogleTagManager] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.GoogleTagManager] {
        def writes(obj: io.flow.checkout.configuration.v0.models.GoogleTagManager) = {
    ...
    implicit def jsonWritesCheckoutConfigurationSnapchatPixel: play.api.libs.json.Writes[SnapchatPixel] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.SnapchatPixel] {
        def writes(obj: io.flow.checkout.configuration.v0.models.SnapchatPixel) = {
          jsObjectSnapchatPixel(obj)
        }
      }
    }

    implicit def jsonReadsCheckoutConfigurationTracker: play.api.libs.json.Reads[Tracker] = new play.api.libs.json.Reads[Tracker] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Tracker] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[Tracker] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesCheckoutConfigurationTracker: play.api.libs.json.Writes[Tracker] = {
      new play.api.libs.json.Writes[io.flow.checkout.configuration.v0.models.Tracker] {
        def writes(obj: io.flow.checkout.configuration.v0.models.Tracker) = {
          jsObjectTracker(obj)
        }
      }
    }
