...
package io.flow.order.price.v0.models {
  ...
  object OrderPriceDetailComponentKey {
     ...
     * rounding.
     */
    case object DutiesItemPrice extends OrderPriceDetailComponentKey {
      override def toString = "duties_item_price"
    }
    /**
     * The duty owed on the freight cost of the order.
     */
    case object DutiesFreight extends OrderPriceDetailComponentKey {
      override def toString = "duties_freight"
    }
    /**
     * The duty owed on the insurance cost of the order.
     */
    case object DutiesInsurance extends OrderPriceDetailComponentKey {
      override def toString = "duties_insurance"
    }
    /**
     * The VAT owed on the price of the order's items, including any added margins and
     * rounding.
     */
    case object VatItemPrice extends OrderPriceDetailComponentKey {
      override def toString = "vat_item_price"
    }
    /**
     * The VAT owed on the freight cost of the order.
     */
    case object VatFreight extends OrderPriceDetailComponentKey {
      override def toString = "vat_freight"
    }
    /**
     * The VAT owed on the insurance cost of the order.
     */
    case object VatInsurance extends OrderPriceDetailComponentKey {
      override def toString = "vat_insurance"
    }
    /**
     * The VAT owed on the duties on the price of the order's items, including any
     * added margins and rounding.
     */
    case object VatDutiesItemPrice extends OrderPriceDetailComponentKey {
      override def toString = "vat_duties_item_price"
    }
    /**
     * The VAT owed on the duties on the freight cost of the order.
     */
    case object VatDutiesFreight extends OrderPriceDetailComponentKey {
      override def toString = "vat_duties_freight"
    }
    /**
     * The VAT owed on the duties on the insurance cost of the order.
     */
    case object VatDutiesInsurance extends OrderPriceDetailComponentKey {
      override def toString = "vat_duties_insurance"
    }
    /**
     * The sum of the price of the order's items with their currency margins, percent
     * margins, and fixed margins included.
     */
    case object ItemPrice extends OrderPriceDetailComponentKey {
      override def toString = "item_price"
    }
    /**
     * The sum of all discounts applied to the order's items.
     */
    case object ItemDiscount extends OrderPriceDetailComponentKey {
      override def toString = "item_discount"
    }
    /**
     * The sum of any rounding applied to the order's items.
     */
    case object Rounding extends OrderPriceDetailComponentKey {
      override def toString = "rounding"
    }
    /**
     * The insurance cost for the order.
     */
    case object Insurance extends OrderPriceDetailComponentKey {
      override def toString = "insurance"
    }
    /**
     * The shipping cost for the order.
     */
    case object Shipping extends OrderPriceDetailComponentKey {
      override def toString = "shipping"
    }
    /**
     * A shipping discount applied to the entire order.
     */
    case object ShippingDiscount extends OrderPriceDetailComponentKey {
      override def toString = "shipping_discount"
    }
    /**
     * A discount applied to the entire order.
     */
    case object OrderDiscount extends OrderPriceDetailComponentKey {
      override def toString = "order_discount"
    }
    /**
     * The sum of adjustments to item price, margin and rounding made due to percentage
     * sales margins.
     */
    case object SubtotalPercentSalesMargin extends OrderPriceDetailComponentKey {
      override def toString = "subtotal_percent_sales_margin"
    }
    /**
     * The sum of adjustments to VAT owed made due to percentage sales margins.
     */
    case object SubtotalVatPercentSalesMargin extends OrderPriceDetailComponentKey {
      override def toString = "subtotal_vat_percent_sales_margin"
    }
    /**
     * The sum of adjustments to duty owed made due to percentage sales margins.
     */
    case object SubtotalDutyPercentSalesMargin extends OrderPriceDetailComponentKey {
      override def toString = "subtotal_duty_percent_sales_margin"
    }
    /**
     ...
     */
    case object VatSubsidy extends OrderPriceDetailComponentKey {
      override def toString = "vat_subsidy"
    }
    /**
     ...
     */
    case object DutySubsidy extends OrderPriceDetailComponentKey {
      override def toString = "duty_subsidy"
    }
    /**
     * Surcharge applied to a shipment for delivery to a remote area determined by the
     * carrier.
     */
    case object RemoteAreaSurcharge extends OrderPriceDetailComponentKey {
      override def toString = "remote_area_surcharge"
    }
    /**
     * Surcharge applied to a shipment for fuel consumption by the carrier.
     */
    case object FuelSurcharge extends OrderPriceDetailComponentKey {
      override def toString = "fuel_surcharge"
    }
    /**
     * Surcharge applied to a shipment during emergency circumstances, such as covid19.
     */
    case object EmergencySituationSurcharge extends OrderPriceDetailComponentKey {
      override def toString = "emergency_situation_surcharge"
    }
    /**
     * Surcharge applied per package during peak times.
     */
    case object PeakSurcharge extends OrderPriceDetailComponentKey {
      override def toString = "peak_surcharge"
    }
    /**
  ...
  object OrderPriceDetailKey {
     ...
     */
    case object Adjustment extends OrderPriceDetailKey {
      override def toString = "adjustment"
    }
    /**
     ...
     * rounding.
     */
    case object Subtotal extends OrderPriceDetailKey {
      override def toString = "subtotal"
    }
    /**
     * The details of any VAT owed on the order.
     */
    case object Vat extends OrderPriceDetailKey {
      override def toString = "vat"
    }
    /**
     * The details of any duties owed on the order.
     */
    case object Duty extends OrderPriceDetailKey {
      override def toString = "duty"
    }
    /**
     * The details of shipping costs for the order.
     */
    case object Shipping extends OrderPriceDetailKey {
      override def toString = "shipping"
    }
    /**
     * The details of insurance costs for the order.
     */
    case object Insurance extends OrderPriceDetailKey {
      override def toString = "insurance"
    }
    /**
     * The details of any discount applied to the order.
     */
    case object Discount extends OrderPriceDetailKey {
      override def toString = "discount"
    }
    /**
     * Additional fees and levies applied to the order
     */
    case object Surcharges extends OrderPriceDetailKey {
      override def toString = "surcharges"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
...
package io.flow.order.price.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsOrderPriceOrderPriceDetailComponentKey: play.api.libs.json.Reads[io.flow.order.price.v0.models.OrderPriceDetailComponentKey] = new play.api.libs.json.Reads[io.flow.order.price.v0.models.OrderPriceDetailComponentKey] {
    ...
    implicit def jsonWritesOrderPriceOrderPriceDetailComponentKey: play.api.libs.json.Writes[OrderPriceDetailComponentKey] = {
      (obj: io.flow.order.price.v0.models.OrderPriceDetailComponentKey) => {
        jsonWritesOrderPriceOrderPriceDetailComponentKey(obj)
      }
    }

    implicit val jsonReadsOrderPriceOrderPriceDetailKey: play.api.libs.json.Reads[io.flow.order.price.v0.models.OrderPriceDetailKey] = new play.api.libs.json.Reads[io.flow.order.price.v0.models.OrderPriceDetailKey] {
    ...
    implicit def jsonWritesOrderPriceOrderPriceDetailKey: play.api.libs.json.Writes[OrderPriceDetailKey] = {
      (obj: io.flow.order.price.v0.models.OrderPriceDetailKey) => {
    ...
    implicit def jsonWritesOrderPriceOrderPriceDetail: play.api.libs.json.Writes[OrderPriceDetail] = {
      (obj: io.flow.order.price.v0.models.OrderPriceDetail) => {
    ...
    implicit def jsonWritesOrderPriceOrderPriceDetailComponent: play.api.libs.json.Writes[OrderPriceDetailComponent] = {
      (obj: io.flow.order.price.v0.models.OrderPriceDetailComponent) => {
