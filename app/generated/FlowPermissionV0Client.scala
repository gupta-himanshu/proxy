 ...
 * apibuilder 0.15.33 app.apibuilder.io/flow/permission/latest/play_2_8_client
 */
package io.flow.permission.v0.models {
  ...
  object FlowRole {
     ...
     */
    case object OrganizationAdmin extends FlowRole { override def toString = "organization_admin" }
    /**
     * Can access merchant functions such as analytics, billing, experiences.
     */
    case object OrganizationMerchant extends FlowRole { override def toString = "organization_merchant" }
    /**
     * Can access customer service functions and retreive relevant data.
     */
    case object OrganizationCustomerService extends FlowRole { override def toString = "organization_customer_service" }
    /**
     * Can access fulfillment functions and retreive relevant data.
     */
    case object OrganizationFulfillment extends FlowRole { override def toString = "organization_fulfillment" }
    /**
     * Can access marketing functions and retreive relevant data.
     */
    case object OrganizationMarketing extends FlowRole { override def toString = "organization_marketing" }
    /**
     * Can access billing and reconcilliation functions and retreive relevant data.
     */
    case object OrganizationFinance extends FlowRole { override def toString = "organization_finance" }
    /**
     * Can access Flow internal functions.
     */
    case object FlowOperations extends FlowRole { override def toString = "flow_operations" }
     ...
     * above.
     */
    val all: scala.List[FlowRole] = scala.List(OrganizationAdmin, OrganizationMerchant, OrganizationCustomerService, OrganizationFulfillment, OrganizationMarketing, OrganizationFinance, FlowOperations)
...
package io.flow.permission.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsPermissionFlowRole = new play.api.libs.json.Reads[io.flow.permission.v0.models.FlowRole] {
    ...
    implicit def jsonWritesPermissionFlowRole: play.api.libs.json.Writes[FlowRole] = {
      new play.api.libs.json.Writes[io.flow.permission.v0.models.FlowRole] {
        def writes(obj: io.flow.permission.v0.models.FlowRole) = {
          jsonWritesPermissionFlowRole(obj)
        }
      }
    }
...
package io.flow.permission.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.15.33 app.apibuilder.io/flow/permission/latest/play_2_8_client"
    val Version = "0.10.59"
    val VersionMajor = 0
