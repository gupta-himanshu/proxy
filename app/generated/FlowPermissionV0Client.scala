...
package io.flow.permission.v0.models {
  ...
  object FlowRole {
     ...
     * above.
     */
    val all: scala.List[FlowRole] = scala.List(OrganizationAdmin, OrganizationMerchant, OrganizationCustomerService, OrganizationFulfillment, OrganizationMarketing, OrganizationFinance, FlowOperations, ChannelAdmin)
...
package io.flow.permission.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesPermissionPermissionError: play.api.libs.json.Writes[PermissionError] = {
      (obj: io.flow.permission.v0.models.PermissionError) => {
