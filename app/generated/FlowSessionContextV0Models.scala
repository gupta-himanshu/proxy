...
package io.flow.session.context.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesSessionContextContext: play.api.libs.json.Writes[Context] = {
      new play.api.libs.json.Writes[io.flow.session.context.v0.models.Context] {
        def writes(obj: io.flow.session.context.v0.models.Context) = {
          jsObjectContext(obj)
        }
      }
    }
    ...
    implicit def jsonWritesSessionContextContextForm: play.api.libs.json.Writes[ContextForm] = {
      new play.api.libs.json.Writes[io.flow.session.context.v0.models.ContextForm] {
        def writes(obj: io.flow.session.context.v0.models.ContextForm) = {
    ...
    implicit def jsonWritesSessionContextContextReference: play.api.libs.json.Writes[ContextReference] = {
      new play.api.libs.json.Writes[io.flow.session.context.v0.models.ContextReference] {
        def writes(obj: io.flow.session.context.v0.models.ContextReference) = {
    ...
    implicit def jsonWritesSessionContextExperimentVariant: play.api.libs.json.Writes[ExperimentVariant] = {
      new play.api.libs.json.Writes[io.flow.session.context.v0.models.ExperimentVariant] {
        def writes(obj: io.flow.session.context.v0.models.ExperimentVariant) = {
    ...
    implicit def jsonWritesSessionContextSessionContextExperiment: play.api.libs.json.Writes[SessionContextExperiment] = {
      new play.api.libs.json.Writes[io.flow.session.context.v0.models.SessionContextExperiment] {
        def writes(obj: io.flow.session.context.v0.models.SessionContextExperiment) = {
