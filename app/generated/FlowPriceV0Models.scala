...
package io.flow.price.v0.models {
  ...
  sealed trait Deminimis extends _root_.scala.Product with _root_.scala.Serializable {
    def deminimisDiscriminator: DeminimisDiscriminator
  ...
  final case class DeminimisPerItem(
    ...
    override val deminimisDiscriminator: DeminimisDiscriminator = DeminimisDiscriminator.DeminimisPerItem
  }
  ...
  final case class DeminimisSimple(
    ...
    override val deminimisDiscriminator: DeminimisDiscriminator = DeminimisDiscriminator.DeminimisSimple
  }
  ...
  final case class DeminimisUndefinedType(
    ...
    override val deminimisDiscriminator: DeminimisDiscriminator = DeminimisDiscriminator.UNDEFINED(description)
  }
  ...
  object PriceAccuracy {
     ...
     */
    case object Calculated extends PriceAccuracy {
     ...
     */
    case object EstimatedFromPartialDestination extends PriceAccuracy {
      override def toString = "estimated_from_partial_destination"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object PriceDetailComponentKey {
     ...
     */
    case object BasePrice extends PriceDetailComponentKey {
      override def toString = "base_price"
    }
    /**
     * A discount applied to the base price of the item.
     */
    case object Discount extends PriceDetailComponentKey {
      override def toString = "discount"
    }
    /**
     * The amount added to the post-discount item price due to FX markup, as configured
     * in the organization's currency settings.
     */
    case object CurrencyMargin extends PriceDetailComponentKey {
      override def toString = "currency_margin"
    }
    /**
     * The amount added to the post-discount item price from a percent item margin.
     * Negative amounts represent discounts.
     */
    case object PercentItemMargin extends PriceDetailComponentKey {
      override def toString = "percent_item_margin"
    }
    /**
     * The amount added to the post-discount item price from a fixed item margin.
     * Negative amounts represent discounts.
     */
    case object FixedItemMargin extends PriceDetailComponentKey {
      override def toString = "fixed_item_margin"
    }
    /**
     * The duty owed on the post-discount base item price.
     */
    case object DutiesItemPrice extends PriceDetailComponentKey {
      override def toString = "duties_item_price"
    }
    /**
     * The duty owed on the sum of the currency margin, percent item margin, and fixed
     * item margin.
     */
    case object DutiesAddedMargin extends PriceDetailComponentKey {
      override def toString = "duties_added_margin"
    }
    /**
     * The duty owed on any rounding applied to the total item price.
     */
    case object DutiesRounding extends PriceDetailComponentKey {
      override def toString = "duties_rounding"
    }
    /**
     * An adjustment made if the item does not meet the duty de minimis rule.
     */
    case object DutiesDeminimis extends PriceDetailComponentKey {
      override def toString = "duties_deminimis"
    }
    /**
     * The VAT owed on the post-discount base item price.
     */
    case object VatItemPrice extends PriceDetailComponentKey {
      override def toString = "vat_item_price"
    }
    /**
     * The VAT owed on the sum of the currency margin, percent item margin, and fixed
     * item margin.
     */
    case object VatAddedMargin extends PriceDetailComponentKey {
      override def toString = "vat_added_margin"
    }
    /**
     * The VAT owed on any rounding applied to the total item price.
     */
    case object VatRounding extends PriceDetailComponentKey {
      override def toString = "vat_rounding"
    }
    /**
     * The VAT owed on the duty owed on the post-discount base item price.
     */
    case object VatDutiesItemPrice extends PriceDetailComponentKey {
      override def toString = "vat_duties_item_price"
    }
    /**
     * The VAT owed on the duty owed on the sum of the currency margin, percent item
     * margin, and fixed item margin.
     */
    case object VatDutiesAddedMargin extends PriceDetailComponentKey {
      override def toString = "vat_duties_added_margin"
    }
    /**
     * The VAT owed on the duty owed on any rounding applied to the total item price.
     */
    case object VatDutiesRounding extends PriceDetailComponentKey {
      override def toString = "vat_duties_rounding"
    }
    /**
     * An adjustment made if the item does not meet the VAT de minimis rule.
     */
    case object VatDeminimis extends PriceDetailComponentKey {
      override def toString = "vat_deminimis"
    }
    /**
     * An adjustment made to the item price as a result of a percent sales margin.
     */
    case object ItemPricePercentSalesMargin extends PriceDetailComponentKey {
      override def toString = "item_price_percent_sales_margin"
    }
    /**
     * An adjustment made to the item margins as a result of a percent sales margin.
     */
    case object MarginsPercentSalesMargin extends PriceDetailComponentKey {
      override def toString = "margins_percent_sales_margin"
    }
    /**
     * An adjustment made to rounding as a result of a percent sales margin.
     */
    case object RoundingPercentSalesMargin extends PriceDetailComponentKey {
      override def toString = "rounding_percent_sales_margin"
    }
    /**
     * An adjustment made to VAT owed as a result of a percent sales margin.
     */
    case object VatPercentSalesMargin extends PriceDetailComponentKey {
      override def toString = "vat_percent_sales_margin"
    }
    /**
     * An adjustment made to VAT on duties (e.g. VAT on duties on item price) owed as a
     * result of a percent sales margin.
     */
    case object VatDutyPercentSalesMargin extends PriceDetailComponentKey {
      override def toString = "vat_duty_percent_sales_margin"
    }
    /**
     * An adjustment made to duty owed as a result of a percent sales margin.
     */
    case object DutyPercentSalesMargin extends PriceDetailComponentKey {
      override def toString = "duty_percent_sales_margin"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object PriceDetailKey {
     ...
     */
    case object ItemPrice extends PriceDetailKey {
      override def toString = "item_price"
    }
    /**
     * The details of any margins added to the item price.
     */
    case object Margins extends PriceDetailKey {
      override def toString = "margins"
    }
    /**
     * The details of any VAT owed on the item.
     */
    case object Vat extends PriceDetailKey {
      override def toString = "vat"
    }
    /**
     * The details of any duties owed on the item.
     */
    case object Duty extends PriceDetailKey {
      override def toString = "duty"
    }
    /**
     * The details of any rounding added to the item.
     */
    case object Rounding extends PriceDetailKey {
      override def toString = "rounding"
    }
    /**
     * The details of any price adjustments due to sales margins. A negative value
     * indicates a discount.
     */
    case object Adjustment extends PriceDetailKey {
      override def toString = "adjustment"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
...
package io.flow.price.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsPriceLevyComponent: play.api.libs.json.Reads[io.flow.price.v0.models.LevyComponent] = new play.api.libs.json.Reads[io.flow.price.v0.models.LevyComponent] {
    ...
    implicit def jsonWritesPriceLevyComponent: play.api.libs.json.Writes[LevyComponent] = {
      (obj: io.flow.price.v0.models.LevyComponent) => {
        jsonWritesPriceLevyComponent(obj)
      }
    }

    implicit val jsonReadsPriceLevyStrategy: play.api.libs.json.Reads[io.flow.price.v0.models.LevyStrategy] = new play.api.libs.json.Reads[io.flow.price.v0.models.LevyStrategy] {
    ...
    implicit def jsonWritesPriceLevyStrategy: play.api.libs.json.Writes[LevyStrategy] = {
      (obj: io.flow.price.v0.models.LevyStrategy) => {
        jsonWritesPriceLevyStrategy(obj)
      }
    }

    implicit val jsonReadsPricePriceAccuracy: play.api.libs.json.Reads[io.flow.price.v0.models.PriceAccuracy] = new play.api.libs.json.Reads[io.flow.price.v0.models.PriceAccuracy] {
    ...
    implicit def jsonWritesPricePriceAccuracy: play.api.libs.json.Writes[PriceAccuracy] = {
      (obj: io.flow.price.v0.models.PriceAccuracy) => {
        jsonWritesPricePriceAccuracy(obj)
      }
    }

    implicit val jsonReadsPricePriceDetailComponentKey: play.api.libs.json.Reads[io.flow.price.v0.models.PriceDetailComponentKey] = new play.api.libs.json.Reads[io.flow.price.v0.models.PriceDetailComponentKey] {
    ...
    implicit def jsonWritesPricePriceDetailComponentKey: play.api.libs.json.Writes[PriceDetailComponentKey] = {
      (obj: io.flow.price.v0.models.PriceDetailComponentKey) => {
        jsonWritesPricePriceDetailComponentKey(obj)
      }
    }

    implicit val jsonReadsPricePriceDetailKey: play.api.libs.json.Reads[io.flow.price.v0.models.PriceDetailKey] = new play.api.libs.json.Reads[io.flow.price.v0.models.PriceDetailKey] {
    ...
    implicit def jsonWritesPricePriceDetailKey: play.api.libs.json.Writes[PriceDetailKey] = {
      (obj: io.flow.price.v0.models.PriceDetailKey) => {
        jsonWritesPricePriceDetailKey(obj)
      }
    }

    implicit val jsonReadsPricePricingLevySetting: play.api.libs.json.Reads[io.flow.price.v0.models.PricingLevySetting] = new play.api.libs.json.Reads[io.flow.price.v0.models.PricingLevySetting] {
    ...
    implicit def jsonWritesPricePricingLevySetting: play.api.libs.json.Writes[PricingLevySetting] = {
      (obj: io.flow.price.v0.models.PricingLevySetting) => {
    ...
    implicit def jsonWritesPriceCurrencyFormat: play.api.libs.json.Writes[CurrencyFormat] = {
      (obj: io.flow.price.v0.models.CurrencyFormat) => {
    ...
    implicit def jsonWritesPriceDeminimisPerItem: play.api.libs.json.Writes[DeminimisPerItem] = {
      (obj: io.flow.price.v0.models.DeminimisPerItem) => {
    ...
    implicit def jsonWritesPriceDeminimisSimple: play.api.libs.json.Writes[DeminimisSimple] = {
      (obj: io.flow.price.v0.models.DeminimisSimple) => {
    ...
    implicit def jsonWritesPriceDuty: play.api.libs.json.Writes[Duty] = {
      (obj: io.flow.price.v0.models.Duty) => {
        jsObjectDuty(obj)
      }
    }
    ...
    implicit def jsonWritesPriceLocalPriceDetails: play.api.libs.json.Writes[LocalPriceDetails] = {
      (obj: io.flow.price.v0.models.LocalPriceDetails) => {
    ...
    implicit def jsonWritesPricePriceBook: play.api.libs.json.Writes[PriceBook] = {
      (obj: io.flow.price.v0.models.PriceBook) => {
    ...
    implicit def jsonWritesPricePriceBookForm: play.api.libs.json.Writes[PriceBookForm] = {
      (obj: io.flow.price.v0.models.PriceBookForm) => {
    ...
    implicit def jsonWritesPricePriceBookItem: play.api.libs.json.Writes[PriceBookItem] = {
      (obj: io.flow.price.v0.models.PriceBookItem) => {
    ...
    implicit def jsonWritesPricePriceBookItemForm: play.api.libs.json.Writes[PriceBookItemForm] = {
      (obj: io.flow.price.v0.models.PriceBookItemForm) => {
    ...
    implicit def jsonWritesPricePriceBookItemQueryForm: play.api.libs.json.Writes[PriceBookItemQueryForm] = {
      (obj: io.flow.price.v0.models.PriceBookItemQueryForm) => {
    ...
    implicit def jsonWritesPricePriceBookItemSchedule: play.api.libs.json.Writes[PriceBookItemSchedule] = {
      (obj: io.flow.price.v0.models.PriceBookItemSchedule) => {
    ...
    implicit def jsonWritesPricePriceBookReference: play.api.libs.json.Writes[PriceBookReference] = {
      (obj: io.flow.price.v0.models.PriceBookReference) => {
    ...
    implicit def jsonWritesPricePriceCheck: play.api.libs.json.Writes[PriceCheck] = {
      (obj: io.flow.price.v0.models.PriceCheck) => {
    ...
    implicit def jsonWritesPricePriceDetail: play.api.libs.json.Writes[PriceDetail] = {
      (obj: io.flow.price.v0.models.PriceDetail) => {
    ...
    implicit def jsonWritesPricePriceDetailComponent: play.api.libs.json.Writes[PriceDetailComponent] = {
      (obj: io.flow.price.v0.models.PriceDetailComponent) => {
    ...
    implicit def jsonWritesPricePriceDetails: play.api.libs.json.Writes[PriceDetails] = {
      (obj: io.flow.price.v0.models.PriceDetails) => {
    ...
    implicit def jsonWritesPricePriceEquation: play.api.libs.json.Writes[PriceEquation] = {
      (obj: io.flow.price.v0.models.PriceEquation) => {
    ...
    implicit def jsonWritesPricePricing: play.api.libs.json.Writes[Pricing] = {
      (obj: io.flow.price.v0.models.Pricing) => {
        jsObjectPricing(obj)
      }
    }
    ...
    implicit def jsonWritesPriceTax: play.api.libs.json.Writes[Tax] = {
      (obj: io.flow.price.v0.models.Tax) => {
        jsObjectTax(obj)
      }
    }

    implicit def jsonReadsPriceDeminimis: play.api.libs.json.Reads[Deminimis] = (js: play.api.libs.json.JsValue) => {
    ...
    implicit def jsonWritesPriceDeminimis: play.api.libs.json.Writes[Deminimis] = {
      (obj: io.flow.price.v0.models.Deminimis) => {
