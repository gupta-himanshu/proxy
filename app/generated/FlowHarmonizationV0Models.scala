 ...
 * apibuilder 0.15.11 app.apibuilder.io/flow/harmonization/latest/play_2_x_json
 */
...
package io.flow.harmonization.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesHarmonizationDetailedTaxRegistration: play.api.libs.json.Writes[DetailedTaxRegistration] = {
      new play.api.libs.json.Writes[io.flow.harmonization.v0.models.DetailedTaxRegistration] {
        def writes(obj: io.flow.harmonization.v0.models.DetailedTaxRegistration) = {
