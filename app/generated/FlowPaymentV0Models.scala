 ...
 * Service version: 0.8.83
 * apibuilder 0.14.96 app.apibuilder.io/flow/payment/latest/play_2_x_json
 */
package io.flow.payment.v0.models {
  ...
  object AuthorizationResultActionDetailsDiscriminator {
    ...
    val all: scala.List[AuthorizationResultActionDetailsDiscriminator] = scala.List(AdyenNativeActionDetails, StripeAuthorizationResultActionDetails)
...
package io.flow.payment.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsPaymentCardPaymentSourceAuthorizationForm: play.api.libs.json.Reads[CardPaymentSourceAuthorizationForm] = {
      ...
      } yield CardPaymentSourceAuthorizationForm(key, cardPaymentSourceId, orderNumber, amount, currency, browserInfo)
    }
    ...
    implicit def jsonReadsPaymentDirectAuthorizationForm: play.api.libs.json.Reads[DirectAuthorizationForm] = {
      for {
        ...
        browserInfo <- (__ \ "browser_info").readNullable[io.flow.payment.v0.models.BrowserInfo]
      } yield DirectAuthorizationForm(token, amount, currency, customer, key, cvv, attributes, destination, billingAddress, ip, options, redirectUrls, browserInfo)
    }
    ...
    implicit def jsonReadsPaymentMerchantOfRecordAuthorizationForm: play.api.libs.json.Reads[MerchantOfRecordAuthorizationForm] = {
      for {
        ...
        redirectUrls <- (__ \ "redirect_urls").readNullable[io.flow.payment.v0.models.PostPaymentRedirectUrls]
        browserInfo <- (__ \ "browser_info").readNullable[io.flow.payment.v0.models.BrowserInfo]
      } yield MerchantOfRecordAuthorizationForm(token, orderNumber, amount, currency, key, cvv, attributes, ip, options, redirectUrls, browserInfo)
    }
