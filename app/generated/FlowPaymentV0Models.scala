...
package io.flow.payment.v0.models {
  ...
  object AuthorizationDeclineCode {
     ...
     */
    case object OnlinePaymentError extends AuthorizationDeclineCode { override def toString = "online_payment_error" }
  ...
  object AuthorizationResultActionType {
     ...
     * the browser.
     */
    case object Native extends AuthorizationResultActionType { override def toString = "native" }
    /**
  ...
  object CardErrorCode {
     ...
     */
    case object InvalidCurrency extends CardErrorCode { override def toString = "invalid_currency" }
    /**
  ...
  object ThreedsTwoChallengeViewport {
     ...
     */
    case object Fullscreen extends ThreedsTwoChallengeViewport { override def toString = "fullscreen" }
...
package io.flow.payment.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsPaymentPaymentSourceConfirmationActionType = new play.api.libs.json.Reads[io.flow.payment.v0.models.PaymentSourceConfirmationActionType] {
    ...
    implicit def jsonWritesPaymentPaymentSourceConfirmationActionType: play.api.libs.json.Writes[PaymentSourceConfirmationActionType] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentSourceConfirmationActionType] {
        def writes(obj: io.flow.payment.v0.models.PaymentSourceConfirmationActionType) = {
    ...
    implicit val jsonReadsPaymentThreedsTwoChallengeViewport = new play.api.libs.json.Reads[io.flow.payment.v0.models.ThreedsTwoChallengeViewport] {
    ...
    implicit def jsonWritesPaymentThreedsTwoChallengeViewport: play.api.libs.json.Writes[ThreedsTwoChallengeViewport] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsTwoChallengeViewport] {
        def writes(obj: io.flow.payment.v0.models.ThreedsTwoChallengeViewport) = {
    ...
    implicit def jsonWritesPaymentAchAuthorizationForm: play.api.libs.json.Writes[AchAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AchAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.AchAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentAdyenChallengeShopperData: play.api.libs.json.Writes[AdyenChallengeShopperData] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AdyenChallengeShopperData] {
        def writes(obj: io.flow.payment.v0.models.AdyenChallengeShopperData) = {
    ...
    implicit def jsonWritesPaymentAdyenIdentifyShopperData: play.api.libs.json.Writes[AdyenIdentifyShopperData] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AdyenIdentifyShopperData] {
        def writes(obj: io.flow.payment.v0.models.AdyenIdentifyShopperData) = {
    ...
    implicit def jsonWritesPaymentAdyenNativeActionDetails: play.api.libs.json.Writes[AdyenNativeActionDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AdyenNativeActionDetails] {
        def writes(obj: io.flow.payment.v0.models.AdyenNativeActionDetails) = {
    ...
    implicit def jsonWritesPaymentApplePayMerchantValidationPayload: play.api.libs.json.Writes[ApplePayMerchantValidationPayload] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ApplePayMerchantValidationPayload] {
        def writes(obj: io.flow.payment.v0.models.ApplePayMerchantValidationPayload) = {
    ...
    implicit def jsonWritesPaymentAuthorizationCopyForm: play.api.libs.json.Writes[AuthorizationCopyForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AuthorizationCopyForm] {
        def writes(obj: io.flow.payment.v0.models.AuthorizationCopyForm) = {
    ...
    implicit def jsonWritesPaymentAuthorizationResultActionGet: play.api.libs.json.Writes[AuthorizationResultActionGet] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AuthorizationResultActionGet] {
        def writes(obj: io.flow.payment.v0.models.AuthorizationResultActionGet) = {
    ...
    implicit def jsonWritesPaymentAuthorizationResultActionNative: play.api.libs.json.Writes[AuthorizationResultActionNative] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AuthorizationResultActionNative] {
        def writes(obj: io.flow.payment.v0.models.AuthorizationResultActionNative) = {
    ...
    implicit def jsonWritesPaymentAuthorizationResultActionPost: play.api.libs.json.Writes[AuthorizationResultActionPost] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AuthorizationResultActionPost] {
        def writes(obj: io.flow.payment.v0.models.AuthorizationResultActionPost) = {
    ...
    implicit def jsonWritesPaymentAuthorizationResultActionWait: play.api.libs.json.Writes[AuthorizationResultActionWait] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AuthorizationResultActionWait] {
        def writes(obj: io.flow.payment.v0.models.AuthorizationResultActionWait) = {
    ...
    implicit def jsonWritesPaymentBrowserInfo: play.api.libs.json.Writes[BrowserInfo] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.BrowserInfo] {
        def writes(obj: io.flow.payment.v0.models.BrowserInfo) = {
    ...
    implicit def jsonWritesPaymentBrowserInlineActionConfiguration: play.api.libs.json.Writes[BrowserInlineActionConfiguration] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.BrowserInlineActionConfiguration] {
        def writes(obj: io.flow.payment.v0.models.BrowserInlineActionConfiguration) = {
    ...
    implicit def jsonWritesPaymentCard: play.api.libs.json.Writes[Card] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.Card] {
        def writes(obj: io.flow.payment.v0.models.Card) = {
          jsObjectCard(obj)
        }
      }
    }
    ...
    implicit def jsonWritesPaymentCardAuthorization: play.api.libs.json.Writes[CardAuthorization] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardAuthorization] {
        def writes(obj: io.flow.payment.v0.models.CardAuthorization) = {
    ...
    implicit def jsonWritesPaymentCardBrowserActionConfiguration: play.api.libs.json.Writes[CardBrowserActionConfiguration] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardBrowserActionConfiguration] {
        def writes(obj: io.flow.payment.v0.models.CardBrowserActionConfiguration) = {
    ...
    implicit def jsonWritesPaymentCardMetadata: play.api.libs.json.Writes[CardMetadata] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardMetadata] {
        def writes(obj: io.flow.payment.v0.models.CardMetadata) = {
    ...
    implicit def jsonWritesPaymentCardPaymentSource: play.api.libs.json.Writes[CardPaymentSource] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardPaymentSource] {
        def writes(obj: io.flow.payment.v0.models.CardPaymentSource) = {
    ...
    implicit def jsonWritesPaymentCardPaymentSourceAuthorizationForm: play.api.libs.json.Writes[CardPaymentSourceAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardPaymentSourceAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.CardPaymentSourceAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentCardPaymentSourceForm: play.api.libs.json.Writes[CardPaymentSourceForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardPaymentSourceForm] {
        def writes(obj: io.flow.payment.v0.models.CardPaymentSourceForm) = {
    ...
    implicit def jsonWritesPaymentCardPaymentSourceSummary: play.api.libs.json.Writes[CardPaymentSourceSummary] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardPaymentSourceSummary] {
        def writes(obj: io.flow.payment.v0.models.CardPaymentSourceSummary) = {
    ...
    implicit def jsonWritesPaymentCardReference: play.api.libs.json.Writes[CardReference] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardReference] {
        def writes(obj: io.flow.payment.v0.models.CardReference) = {
    ...
    implicit def jsonWritesPaymentCardSummary: play.api.libs.json.Writes[CardSummary] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CardSummary] {
        def writes(obj: io.flow.payment.v0.models.CardSummary) = {
    ...
    implicit def jsonWritesPaymentCryptopayAuthorizationDetails: play.api.libs.json.Writes[CryptopayAuthorizationDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.CryptopayAuthorizationDetails] {
        def writes(obj: io.flow.payment.v0.models.CryptopayAuthorizationDetails) = {
    ...
    implicit def jsonWritesPaymentDirectAuthorizationForm: play.api.libs.json.Writes[DirectAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.DirectAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.DirectAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentDirectDebit: play.api.libs.json.Writes[DirectDebit] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.DirectDebit] {
        def writes(obj: io.flow.payment.v0.models.DirectDebit) = {
    ...
    implicit def jsonWritesPaymentGooglePayAuthorizationPayload: play.api.libs.json.Writes[GooglePayAuthorizationPayload] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.GooglePayAuthorizationPayload] {
        def writes(obj: io.flow.payment.v0.models.GooglePayAuthorizationPayload) = {
    ...
    implicit def jsonWritesPaymentInlineAuthorizationDetails: play.api.libs.json.Writes[InlineAuthorizationDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.InlineAuthorizationDetails] {
        def writes(obj: io.flow.payment.v0.models.InlineAuthorizationDetails) = {
    ...
    implicit def jsonWritesPaymentInlineAuthorizationForm: play.api.libs.json.Writes[InlineAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.InlineAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.InlineAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentMerchantOfRecordAuthorizationForm: play.api.libs.json.Writes[MerchantOfRecordAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.MerchantOfRecordAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.MerchantOfRecordAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentMerchantOfRecordPaymentForm: play.api.libs.json.Writes[MerchantOfRecordPaymentForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.MerchantOfRecordPaymentForm] {
        def writes(obj: io.flow.payment.v0.models.MerchantOfRecordPaymentForm) = {
    ...
    implicit def jsonWritesPaymentOnlineAuthorization: play.api.libs.json.Writes[OnlineAuthorization] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.OnlineAuthorization] {
        def writes(obj: io.flow.payment.v0.models.OnlineAuthorization) = {
    ...
    implicit def jsonWritesPaymentOnlinePaymentAuthorizationForm: play.api.libs.json.Writes[OnlinePaymentAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.OnlinePaymentAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.OnlinePaymentAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentPaymentCryptopay: play.api.libs.json.Writes[PaymentCryptopay] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentCryptopay] {
        def writes(obj: io.flow.payment.v0.models.PaymentCryptopay) = {
    ...
    implicit def jsonWritesPaymentPaymentPaypal: play.api.libs.json.Writes[PaymentPaypal] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentPaypal] {
        def writes(obj: io.flow.payment.v0.models.PaymentPaypal) = {
    ...
    implicit def jsonWritesPaymentPaymentProcessor: play.api.libs.json.Writes[PaymentProcessor] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentProcessor] {
        def writes(obj: io.flow.payment.v0.models.PaymentProcessor) = {
    ...
    implicit def jsonWritesPaymentPaymentProcessorAccount: play.api.libs.json.Writes[PaymentProcessorAccount] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentProcessorAccount] {
        def writes(obj: io.flow.payment.v0.models.PaymentProcessorAccount) = {
    ...
    implicit def jsonWritesPaymentPaymentProcessorAccountReference: play.api.libs.json.Writes[PaymentProcessorAccountReference] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentProcessorAccountReference] {
        def writes(obj: io.flow.payment.v0.models.PaymentProcessorAccountReference) = {
    ...
    implicit def jsonWritesPaymentPaymentProcessorIdentifier: play.api.libs.json.Writes[PaymentProcessorIdentifier] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentProcessorIdentifier] {
        def writes(obj: io.flow.payment.v0.models.PaymentProcessorIdentifier) = {
    ...
    implicit def jsonWritesPaymentPaymentProcessorReference: play.api.libs.json.Writes[PaymentProcessorReference] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentProcessorReference] {
        def writes(obj: io.flow.payment.v0.models.PaymentProcessorReference) = {
    ...
    implicit def jsonWritesPaymentPaymentSourceConfirmationAction: play.api.libs.json.Writes[PaymentSourceConfirmationAction] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentSourceConfirmationAction] {
        def writes(obj: io.flow.payment.v0.models.PaymentSourceConfirmationAction) = {
    ...
    implicit def jsonWritesPaymentPaypalAuthorizationDetails: play.api.libs.json.Writes[PaypalAuthorizationDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaypalAuthorizationDetails] {
        def writes(obj: io.flow.payment.v0.models.PaypalAuthorizationDetails) = {
    ...
    implicit def jsonWritesPaymentPaypalAuthorizationForm: play.api.libs.json.Writes[PaypalAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaypalAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.PaypalAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentRedirectAuthorizationDetails: play.api.libs.json.Writes[RedirectAuthorizationDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.RedirectAuthorizationDetails] {
        def writes(obj: io.flow.payment.v0.models.RedirectAuthorizationDetails) = {
    ...
    implicit def jsonWritesPaymentRedirectAuthorizationForm: play.api.libs.json.Writes[RedirectAuthorizationForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.RedirectAuthorizationForm] {
        def writes(obj: io.flow.payment.v0.models.RedirectAuthorizationForm) = {
    ...
    implicit def jsonWritesPaymentStripeAuthenticationData: play.api.libs.json.Writes[StripeAuthenticationData] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.StripeAuthenticationData] {
        def writes(obj: io.flow.payment.v0.models.StripeAuthenticationData) = {
    ...
    implicit def jsonWritesPaymentStripeAuthenticationDataForm: play.api.libs.json.Writes[StripeAuthenticationDataForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.StripeAuthenticationDataForm] {
        def writes(obj: io.flow.payment.v0.models.StripeAuthenticationDataForm) = {
    ...
    implicit def jsonWritesPaymentStripeAuthorizationResultActionDetails: play.api.libs.json.Writes[StripeAuthorizationResultActionDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.StripeAuthorizationResultActionDetails] {
        def writes(obj: io.flow.payment.v0.models.StripeAuthorizationResultActionDetails) = {
    ...
    implicit def jsonWritesPaymentThreedsChallengeActionDetails: play.api.libs.json.Writes[ThreedsChallengeActionDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsChallengeActionDetails] {
        def writes(obj: io.flow.payment.v0.models.ThreedsChallengeActionDetails) = {
    ...
    implicit def jsonWritesPaymentThreedsIdentifyActionDetails: play.api.libs.json.Writes[ThreedsIdentifyActionDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsIdentifyActionDetails] {
        def writes(obj: io.flow.payment.v0.models.ThreedsIdentifyActionDetails) = {
    ...
    implicit def jsonWritesPaymentThreedsTwoChallengeRequest: play.api.libs.json.Writes[ThreedsTwoChallengeRequest] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsTwoChallengeRequest] {
        def writes(obj: io.flow.payment.v0.models.ThreedsTwoChallengeRequest) = {
    ...
    implicit def jsonWritesPaymentThreedsTwoMethod: play.api.libs.json.Writes[ThreedsTwoMethod] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsTwoMethod] {
        def writes(obj: io.flow.payment.v0.models.ThreedsTwoMethod) = {
    ...
    implicit def jsonReadsPaymentAdyenNativeData: play.api.libs.json.Reads[AdyenNativeData] = new play.api.libs.json.Reads[AdyenNativeData] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[AdyenNativeData] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[AdyenNativeData] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentAdyenNativeData: play.api.libs.json.Writes[AdyenNativeData] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AdyenNativeData] {
        def writes(obj: io.flow.payment.v0.models.AdyenNativeData) = {
    ...
    implicit def jsonReadsPaymentAuthorizationResultActionDetails: play.api.libs.json.Reads[AuthorizationResultActionDetails] = new play.api.libs.json.Reads[AuthorizationResultActionDetails] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[AuthorizationResultActionDetails] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[AuthorizationResultActionDetails] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentAuthorizationResultActionDetails: play.api.libs.json.Writes[AuthorizationResultActionDetails] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.AuthorizationResultActionDetails] {
        def writes(obj: io.flow.payment.v0.models.AuthorizationResultActionDetails) = {
          jsObjectAuthorizationResultActionDetails(obj)
        }
      }
    }

    implicit def jsonReadsPaymentBrowserActionConfiguration: play.api.libs.json.Reads[BrowserActionConfiguration] = new play.api.libs.json.Reads[BrowserActionConfiguration] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[BrowserActionConfiguration] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[BrowserActionConfiguration] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentBrowserActionConfiguration: play.api.libs.json.Writes[BrowserActionConfiguration] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.BrowserActionConfiguration] {
        def writes(obj: io.flow.payment.v0.models.BrowserActionConfiguration) = {
    ...
    implicit def jsonReadsPaymentExpandablePaymentProcessor: play.api.libs.json.Reads[ExpandablePaymentProcessor] = new play.api.libs.json.Reads[ExpandablePaymentProcessor] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ExpandablePaymentProcessor] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[ExpandablePaymentProcessor] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentExpandablePaymentProcessor: play.api.libs.json.Writes[ExpandablePaymentProcessor] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ExpandablePaymentProcessor] {
        def writes(obj: io.flow.payment.v0.models.ExpandablePaymentProcessor) = {
    ...
    implicit def jsonReadsPaymentInlineActionConfiguration: play.api.libs.json.Reads[InlineActionConfiguration] = new play.api.libs.json.Reads[InlineActionConfiguration] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[InlineActionConfiguration] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[InlineActionConfiguration] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentInlineActionConfiguration: play.api.libs.json.Writes[InlineActionConfiguration] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.InlineActionConfiguration] {
        def writes(obj: io.flow.payment.v0.models.InlineActionConfiguration) = {
    ...
    implicit def jsonReadsPaymentPaymentSource: play.api.libs.json.Reads[PaymentSource] = new play.api.libs.json.Reads[PaymentSource] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[PaymentSource] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[PaymentSource] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentPaymentSource: play.api.libs.json.Writes[PaymentSource] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentSource] {
        def writes(obj: io.flow.payment.v0.models.PaymentSource) = {
          jsObjectPaymentSource(obj)
        }
      }
    }

    implicit def jsonReadsPaymentPaymentSourceForm: play.api.libs.json.Reads[PaymentSourceForm] = new play.api.libs.json.Reads[PaymentSourceForm] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[PaymentSourceForm] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[PaymentSourceForm] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentPaymentSourceForm: play.api.libs.json.Writes[PaymentSourceForm] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.PaymentSourceForm] {
        def writes(obj: io.flow.payment.v0.models.PaymentSourceForm) = {
          jsObjectPaymentSourceForm(obj)
        }
      }
    }

    implicit def jsonReadsPaymentThreedsChallengeAction: play.api.libs.json.Reads[ThreedsChallengeAction] = new play.api.libs.json.Reads[ThreedsChallengeAction] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ThreedsChallengeAction] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[ThreedsChallengeAction] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentThreedsChallengeAction: play.api.libs.json.Writes[ThreedsChallengeAction] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsChallengeAction] {
        def writes(obj: io.flow.payment.v0.models.ThreedsChallengeAction) = {
          jsObjectThreedsChallengeAction(obj)
        }
      }
    }

    implicit def jsonReadsPaymentThreedsIdentifyAction: play.api.libs.json.Reads[ThreedsIdentifyAction] = new play.api.libs.json.Reads[ThreedsIdentifyAction] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ThreedsIdentifyAction] = {
        (js \ "discriminator").asOpt[String].getOrElse { sys.error("Union[ThreedsIdentifyAction] requires a discriminator named 'discriminator' - this field was not found in the Json Value") } match {
    ...
    implicit def jsonWritesPaymentThreedsIdentifyAction: play.api.libs.json.Writes[ThreedsIdentifyAction] = {
      new play.api.libs.json.Writes[io.flow.payment.v0.models.ThreedsIdentifyAction] {
        def writes(obj: io.flow.payment.v0.models.ThreedsIdentifyAction) = {
