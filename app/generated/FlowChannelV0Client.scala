...
package io.flow.channel.v0.models {
  ...
  final case class ChannelOrganization(
    ...
    channel: io.flow.channel.v0.models.ChannelReference
  )
...
package io.flow.channel.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsChannelChannelForm: play.api.libs.json.Reads[ChannelForm] = {
      (__ \ "name").read[String].map { x => new ChannelForm(name = x) }
    }
    ...
    implicit def jsonReadsChannelChannelOrganization: play.api.libs.json.Reads[ChannelOrganization] = {
      for {
        ...
        channel <- (__ \ "channel").read[io.flow.channel.v0.models.ChannelReference]
      } yield ChannelOrganization(id, organization, channel)
    }
    ...
    def jsObjectChannelOrganization(obj: io.flow.channel.v0.models.ChannelOrganization): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "channel" -> jsObjectChannelReference(obj.channel)
      )
    }
    ...
    implicit def jsonReadsChannelChannelReference: play.api.libs.json.Reads[ChannelReference] = {
      (__ \ "id").read[String].map { x => new ChannelReference(id = x) }
    }

    def jsObjectChannelReference(obj: io.flow.channel.v0.models.ChannelReference): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "id" -> play.api.libs.json.JsString(obj.id)
      )
    }

    implicit def jsonWritesChannelChannelReference: play.api.libs.json.Writes[ChannelReference] = {
      (obj: io.flow.channel.v0.models.ChannelReference) => {
  ...
  class Client(
    ...
    object ChannelOrganizations extends ChannelOrganizations {
      ...
      override def getById(
        ...
        _executeRequest("GET", s"/channel/${play.utils.UriEncoding.encodePathSegment(channelId, "UTF-8")}/organizations/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
      ...
      override def putById(
        ...
        _executeRequest("PUT", s"/channel/${play.utils.UriEncoding.encodePathSegment(channelId, "UTF-8")}/organizations/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.channel.v0.Client.parseJson("io.flow.channel.v0.models.ChannelOrganization", r, _.validate[io.flow.channel.v0.models.ChannelOrganization])
      ...
      override def deleteById(
        ...
        _executeRequest("DELETE", s"/channel/${play.utils.UriEncoding.encodePathSegment(channelId, "UTF-8")}/organizations/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}", requestHeaders = requestHeaders).map {
