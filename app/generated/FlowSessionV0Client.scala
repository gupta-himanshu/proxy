 ...
 * apibuilder 0.14.93 app.apibuilder.io/flow/session/latest/play_2_8_client
 */
package io.flow.session.v0.models {
  ...
  final case class SessionForm(
    ...
    experiment: _root_.scala.Option[io.flow.session.v0.models.SessionExperimentForm] = None
  )
...
package io.flow.session.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesSessionOrganizationSession: play.api.libs.json.Writes[OrganizationSession] = {
      new play.api.libs.json.Writes[io.flow.session.v0.models.OrganizationSession] {
        def writes(obj: io.flow.session.v0.models.OrganizationSession) = {
    ...
    implicit def jsonWritesSessionOrganizationSessionAuthorization: play.api.libs.json.Writes[OrganizationSessionAuthorization] = {
      new play.api.libs.json.Writes[io.flow.session.v0.models.OrganizationSessionAuthorization] {
        def writes(obj: io.flow.session.v0.models.OrganizationSessionAuthorization) = {
    ...
    implicit def jsonWritesSessionSessionExperimentForm: play.api.libs.json.Writes[SessionExperimentForm] = {
      new play.api.libs.json.Writes[io.flow.session.v0.models.SessionExperimentForm] {
        def writes(obj: io.flow.session.v0.models.SessionExperimentForm) = {
    ...
    implicit def jsonWritesSessionSessionExperimentVariantForm: play.api.libs.json.Writes[SessionExperimentVariantForm] = {
      new play.api.libs.json.Writes[io.flow.session.v0.models.SessionExperimentVariantForm] {
        def writes(obj: io.flow.session.v0.models.SessionExperimentVariantForm) = {
    ...
    implicit def jsonReadsSessionSessionForm: play.api.libs.json.Reads[SessionForm] = {
      for {
        ...
        experiment <- (__ \ "experiment").readNullable[io.flow.session.v0.models.SessionExperimentForm]
    ...
    def jsObjectSessionForm(obj: io.flow.session.v0.models.SessionForm): play.api.libs.json.JsObject = {
      ...
      (obj.experiment match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("experiment" -> jsObjectSessionExperimentForm(x))
      })
    }
...
package io.flow.session.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.93 app.apibuilder.io/flow/session/latest/play_2_8_client"
    val Version = "0.7.65"
    val VersionMajor = 0
