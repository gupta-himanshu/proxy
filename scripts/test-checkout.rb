...
session_id = "F51K1GrlCvRMkMypgYDDDVWL94SpTnhNgORbA5eI7P6BUc4KLfGwWTFLB2GN4oQU"
id = "shopify-dev-sandbox"
...
assert_status(201, response)
json = ProxyGlobal.parse_json(response.body)
items = json['builder']['order']['items']
assert_equals(items.size, 1)
assert_equals(items.first['number'], "13211230175332")
assert_nil(json['builder']['errors'])
